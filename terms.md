...
These Terms of Service ("Terms") govern your use of the Answered mobile application and web application ("Answered," "the app," "we," "us," or "our"). Answered is operated by Ellasid LLC, a Wisconsin limited liability company. By downloading, installing, visiting, or using Answered, you agree to these Terms.

If you do not agree to these Terms, do not use the app.

## 1. What Answered is — and is not

Answered is an educational and document-preparation tool for people who have been sued by a debt collector or debt buyer in state court. The app currently covers cases filed in Wisconsin, Illinois, New York, Florida, Ohio, Texas, Minnesota, Pennsylvania, Michigan, Georgia, Kentucky, Indiana, Virginia, Missouri, California, New Jersey, Arizona, and North Carolina. The app helps you:
...
In states where Answered currently supports clerical paper mailing (currently Wisconsin, Texas, Pennsylvania, Ohio, Minnesota, and Michigan), Answered also offers an optional **Mail Filing Service** -- a non-legal, clerical print-and-mail service described in Section 5 below.
...
You must be at least 18 years old and a resident of a state the app currently covers (Wisconsin, Illinois, New York, Florida, Ohio, Texas, Minnesota, Pennsylvania, Michigan, Georgia, Kentucky, Indiana, Virginia, Missouri, California, New Jersey, Arizona, or North Carolina) to use Answered for a case filed in that state. You may only use the app for your own legal matter. You may not use the app on behalf of anyone else, and you may not use it to provide legal services to any third party.

## 3. Your account

Answered creates an anonymous account for you when you first open the app or begin using the web application. Your data is tied to that account and persists on your device, in your browser, and on our servers until you delete the app, clear local browser data, or request account deletion. If you provide an email address during checkout, account recovery, or support, we may attach that email address to your account so you can regain access. You are responsible for the device and browser you use to access Answered.

## 4. Payments

Answered is free to download and free to scan and review your case. Paid offerings may be available through the Apple App Store in the mobile app and through Stripe on the web:

- **Answered Pro** -- a one-time upgrade for $99 USD that unlocks the full playbook and Answer generator. The purchase is a one-time charge, not a subscription.
- **Mail Filing Service** -- a one-time purchase (currently $50 USD) that you may buy each time you want Answered to print and mail a generated Answer for you. See Section 5 for the full terms of this service.

Apple, RevenueCat, and Stripe process payments and purchase entitlements. We do not see or store your full payment card details.

**Refunds for Answered Pro** are handled through the payment processor used for your purchase. For App Store purchases, request a refund through Apple's standard refund process at [reportaproblem.apple.com](https://reportaproblem.apple.com). For web purchases, email [support@ellasid.com](mailto:support@ellasid.com). If the unlocked playbook does not work as described, you are encouraged to request a refund.
...
Answered will refund the full $50 Mail Filing Service fee if:
...
Refunds are issued back through the payment processor used for your purchase where possible, or through another reasonable refund method if processor limitations require it. Answered does not refund the Mail Filing Service fee on the basis of the legal merits of your Answer, a court ruling in your case, or your disagreement with the content of the document you generated and approved before purchase.
...
The Mail Filing Service is currently offered only for cases filed in Wisconsin, Texas, Pennsylvania, Ohio, Minnesota, and Michigan. If your state requires electronic filing, or if Answered does not currently support mail filing in your state or court, Answered does not file for you; you must file your Answer yourself through the applicable electronic filing portal, clerk's office, or other court-approved method.
